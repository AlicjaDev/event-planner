...
let events = [
  { date: "10/5/2023", time: "10:00 AM", title: "Meeting", description: "Team meeting" },
  { date: "10/5/2023", time: "02:00 PM", title: "Lunch", description: "Lunch with client" },
];

function load() {
  // Use the hardcoded events array
}
...
//       console.log("Day:", dayString, "Events:", eventsForDay); // Debugging
...
//       .then(() => {
//         closeModal();
//         load(); // Reload events after saving
//       })
//       .catch((error) => {
